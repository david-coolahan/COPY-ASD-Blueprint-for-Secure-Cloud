...
In accordance with the [`<SYSTEM-NAME>` Vulnerability and Patch Management Process](/security-and-governance/general-documentation), `<ORGANISATION-NAME>` will monitor Microsoft support for Windows, and ensure that all operating systems on workstations are removed prior to this support ending.

`<INSERT ADDITIONAL INFORMATION AS APPROPRIATE>`

##### Hybrid servers

In accordance with the [`<SYSTEM-NAME>` Vulnerability and Patch Management Process](/security-and-governance/general-documentation), `<ORGANISATION-NAME>` will monitor Microsoft support for Windows, and ensure that all operating systems on servers are removed prior to this support ending.
...
- Microsoft's [_Guidance for meeting ASD's Essential Eight - Patch Operating Systems_](https://learn.microsoft.com/en-au/compliance/anz/e8-patch-os)
