...
Purview [Data Lifecycle Management policies](/design/shared-services/purview/data-lifecycle-management) can be modified to ensure that data is retained for longer than the defined seven years:
